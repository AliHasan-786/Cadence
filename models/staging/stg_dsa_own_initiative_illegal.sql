...
-- Sheet 5: own-initiative measures against illegal content.
-- Wide table with 21 metric columns + 16 contextual notes columns.

WITH source AS (
    SELECT * FROM {{ source('cadence_raw', 'raw_dsa_own_initiative_illegal') }}
)
